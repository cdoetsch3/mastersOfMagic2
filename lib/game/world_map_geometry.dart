...
abstract final class WorldMapGeometry {
  ...
  static const List<MapLabel> featureLabels = [
    ...
    MapLabel('CINDERLANDS', Offset(372, 1020), MapLabelTone.warm),
    MapLabel(
      'RIVER CONCORD',
      Offset(646, 1178),
      MapLabelTone.river,
  ...
  static const Map<String, Offset> positions = {
    ...
    'cinderpeak_foothills': Offset(408, 1100),
    'ashfall_vale': Offset(286, 1106),
    'pennycross': Offset(596, 1152),
    ...
    'the_molten_deep': Offset(318, 976),
    ...
    'the_sunless_reach': Offset(706, 494),
