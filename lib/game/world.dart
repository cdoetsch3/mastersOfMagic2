...
abstract final class World {
  ...
  static const List<GameLocation> locations = [
    ...
    GameLocation(
      ...
      elements: [MagicElement.aqua, MagicElement.radiant],
      minLevel: 2,
      maxLevel: 6,
    ...
    GameLocation(
      ...
      elements: [MagicElement.geo, MagicElement.radiant],
      minLevel: 16,
      maxLevel: 24,
      connections: ['forgeholm'],
    ),
    ...
    GameLocation(
      ...
      elements: [MagicElement.umbra, MagicElement.radiant],
      minLevel: 55,
      maxLevel: 60,
