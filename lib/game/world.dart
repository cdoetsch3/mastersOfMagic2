...
abstract final class World {
  ...
  static const List<GameLocation> locations = [
    ...
    GameLocation(
      ...
      elements: [MagicElement.earth, MagicElement.air],
      minLevel: 1,
      maxLevel: 5,
    ...
    GameLocation(
      ...
      elements: [MagicElement.water, MagicElement.light],
      minLevel: 2,
      maxLevel: 6,
    ...
    GameLocation(
      ...
      elements: [MagicElement.earth, MagicElement.light],
      minLevel: 16,
      maxLevel: 24,
      connections: ['forgeholm'],
    ),
    GameLocation(
      ...
      elements: [MagicElement.water, MagicElement.electric],
      minLevel: 8,
      maxLevel: 14,
    ...
    GameLocation(
      ...
      elements: [MagicElement.ice, MagicElement.air],
      minLevel: 18,
      maxLevel: 26,
    ...
    GameLocation(
      ...
      elements: [MagicElement.electric, MagicElement.air],
      minLevel: 26,
      maxLevel: 34,
    ...
    GameLocation(
      ...
      elements: [MagicElement.water, MagicElement.ice],
      minLevel: 26,
      maxLevel: 34,
    ...
    GameLocation(
      ...
      elements: [MagicElement.water, MagicElement.shadow],
      minLevel: 38,
      maxLevel: 46,
