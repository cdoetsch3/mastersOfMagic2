...
///
/// 📝 **Superseded by `LadderAi`** for opponents — intelligence is now a
/// capability ladder rather than a blunder dial (GAME_DESIGN §6b). Kept because
/// the lockstep tests use it as a cheap deterministic-under-seed brain.
///
/// Every instinct is a dial:
